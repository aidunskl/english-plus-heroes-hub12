...
const WAYGROUND_URL = "https://wayground.com/join/quiz/6911de02c1e7154c25c33568/start?studentShare=true";

const AltynaiWaygroundQuizTwo = () => {
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Wayground платформасындағы екінші интерактивті викторина
                </p>
...
export default AltynaiWaygroundQuizTwo;
