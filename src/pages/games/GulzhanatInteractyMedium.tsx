...
const GulzhanatInteractyMedium = () => {
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
              <div>
                ...
                <h1 className="text-3xl font-bold mb-2">
                  Interacty Medium Game - Орта деңгей
                </h1>
                <p className="text-muted-foreground mb-4">
                  Орта деңгейдегі ағылшын тілі ойыны
                </p>
          ...
          <Card className="p-6 mb-6">
            <div className="text-center">
              ...
              <Button 
                onClick={() => window.open("https://interacty.me/projects/929cf3076faef867", "_blank")}
                size="lg"
                className="gap-2"
              >
...
export default GulzhanatInteractyMedium;
