        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 mb-6">
              <div>
                ...
                <h1 className="text-3xl font-bold mb-2">
                  Interacty Interactive Project
                </h1>
                <p className="text-muted-foreground mb-4">
                  Интерактивті ағылшын тілі ойыны
                </p>
          ...
          <Card className="p-6 mb-6">
            <div className="text-center">
              ...
              <Button 
                onClick={() => window.open("https://interacty.me/projects/35637a7daecbcae8", "_blank")}
                size="lg"
                className="gap-2"
              >
          ...
          <Card className="mt-8 p-6 bg-muted/30">
            ...
            <ul className="space-y-2 text-muted-foreground">
              <li>• Интерактивті тапсырмалар</li>
              <li>• Тіл дағдыларын дамыту</li>
              <li>• Жасанды интеллект элементтері</li>
              <li>• Кешенді оқу тәжірибесі</li>
            </ul>
          </Card>
        </div>
      </div>
...
export default SholpanInteractyProject;
