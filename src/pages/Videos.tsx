...
const Videos = () => {
  ...
  const videos = [
    {
      id: "lesson1-countries-intro",
      title: "Lesson 1: Countries Introduction",
      duration: "5:30",
      lesson: "Lesson 1",
      description: "Елдер мен ұлттарды таныстыру. Countries & Nationalities негіздері.",
    ...
    {
      id: "lesson1-where-are-you-from",
      title: "Lesson 1: Where are you from?",
      duration: "6:45",
      lesson: "Lesson 1",
      description: "'Where are you from?' сұрағына жауап беруді үйрену.",
    ...
    {
      id: "lesson2-languages-around-world",
      title: "Lesson 2: Languages Around the World",
      duration: "7:20",
      lesson: "Lesson 2",
      description: "Әлемдік тілдер туралы видео. Languages & Guessing дағдылары.",
    ...
    {
      id: "lesson3-present-simple-grammar",
      title: "Lesson 3: Present Simple Grammar",
      duration: "8:15",
      lesson: "Lesson 3",
      description: "Present Simple грамматикасы: affirmative, negative формалары.",
    ...
    {
      id: "lesson3-present-simple-questions",
      title: "Lesson 3: Present Simple Questions",
      duration: "7:50",
      lesson: "Lesson 3",
      description: "Present Simple сұрақ формаларын қалай құру керек.",
    ...
    {
      id: "lesson4-cosmopolitan-city-tour",
      title: "Lesson 4: A Cosmopolitan City Tour",
      duration: "9:30",
      lesson: "Lesson 4",
      description: "Космополитикалық қала туралы видео. Reading дағдыларын дамыту.",
